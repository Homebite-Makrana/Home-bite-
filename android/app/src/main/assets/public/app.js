...
async function checkout(){
  ...
  try{
    if(!navigator.geolocation){
      return alert("Location service is not available. Please enable Location on your phone and try again.");
    }
...
if(!navigator.geolocation)return alert("Location service is not available. Please enable Location on your phone and try again.");
const pos=await new Promise((resolve,reject)=>{
